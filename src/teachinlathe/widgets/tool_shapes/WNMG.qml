...
/*
 * WNMG.qml — trigon 80°, negativă dublu-fețe — 6 muchii, degroșare
 *
 * Utilizare:
...
Item {
    ...
    enum Size { S06, S08, S10 }

    // ---- parametri --------------------------------------------------------
    property int  size: WNMG.Size.S08
    ...
    // ---- date familie -----------------------------------------------------
    readonly property string family: "WNMG"
    readonly property string shape: "W"
    readonly property string insertType: "G"
    readonly property var icValues: [9.525, 12.7, 15.875]          // mm, în ordinea enum-ului
    readonly property var sizeCodes: ["06", "08", "10"]

...
/*
 * DCMT.qml — romb 55°, pozitivă — profilare, acces în unghi
 *
 * Utilizare:
...
Item {
    ...
    enum Size { S07, S11, S15 }

    // ---- parametri --------------------------------------------------------
    property int  size: DCMT.Size.S11
    ...
    // ---- date familie -----------------------------------------------------
    readonly property string family: "DCMT"
    readonly property string shape: "D"
    readonly property string insertType: "T"
    readonly property var icValues: [6.35, 9.525, 12.7]          // mm, în ordinea enum-ului
    readonly property var sizeCodes: ["07", "11", "15"]

...
def _load_custom_profiling_module():
    for name in ["x", "x.operations", "x.operations.custom_cam"]:
    ...
    module_order = [
        ...
        ("x.operations.custom_cam.custom_profiling_types", BASE / "operations" / "custom_cam" / "custom_profiling_types.py"),
        ("x.operations.custom_cam.custom_profiling_geometry", BASE / "operations" / "custom_cam" / "custom_profiling_geometry.py"),
        ("x.operations.custom_cam.custom_profiling_planner", BASE / "operations" / "custom_cam" / "custom_profiling_planner.py"),
...
class CustomProfilingRegressionTest(unittest.TestCase):
    ...
    def test_roughing_output_snapshot(self):
        self.assertEqual(self._generate(self.rough), [
            ...
            "G2 X40.591 Z-38.459 I9.944 K1.058",
            "G3 X41.500 Z-39.454 I-0.091 K-0.996",
            "G1 X41.500 Z-55.410",
            "G2 X44.264 Z-59.882 I5.000 K0.000",
            "G1 X51.500 Z-63.500",
            "G0 X53.000 Z0.000",
        ])
    ...
    def test_finishing_output_snapshot(self):
        self.assertEqual(self._generate(self.finish), [
            ...
            "G2 X40.091 Z-38.959 I9.944 K1.058",
            "G3 X41.000 Z-39.954 I-0.091 K-0.996",
            "G1 X41.000 Z-55.910",
            "G2 X43.764 Z-60.382 I5.000 K0.000",
            "G1 X51.000 Z-64.000",
            "G0 X53.000 Z0.000",
            "G0 X20.500 Z0.000",
            "G1 X20.500 Z-23.264",
            ...
            "G2 X39.591 Z-39.459 I9.944 K1.058",
            "G3 X40.500 Z-40.454 I-0.091 K-0.996",
            "G1 X40.500 Z-56.410",
            "G2 X43.264 Z-60.882 I5.000 K0.000",
            "G1 X50.500 Z-64.500",
            "G0 X53.000 Z0.000",
            "G0 X20.000 Z0.000",
            "G1 X20.000 Z-23.764",
            ...
            "G2 X39.091 Z-39.959 I9.944 K1.058",
            "G3 X40.000 Z-40.954 I-0.091 K-0.996",
            "G1 X40.000 Z-56.910",
            "G2 X42.764 Z-61.382 I5.000 K0.000",
            "G1 X50.000 Z-65.000",
            "G0 X53.000 Z0.000",
            "G0 X20.000 Z0.000",
            "G1 X20.000 Z-23.764",
